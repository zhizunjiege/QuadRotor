...
void HoverControlModelClass::step()
{
  ...
  if (rtmIsMajorTimeStep((&HoverControl_M))) {
    ...
    if (!((&HoverControl_M)->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&(&HoverControl_M)->solverInfo, (((&HoverControl_M
        )->Timing.clockTickH0 + 1) * (&HoverControl_M)->Timing.stepSize0 *
        4294967296.0));
    } else {
      rtsiSetSolverStopTime(&(&HoverControl_M)->solverInfo, (((&HoverControl_M
        )->Timing.clockTick0 + 1) * (&HoverControl_M)->Timing.stepSize0 +
        (&HoverControl_M)->Timing.clockTickH0 * (&HoverControl_M)
  ...
  HoverControl_B.NProdOut = (rtb_Sum1 * HoverControl_U.k_x_pid[2] -
    HoverControl_X.Filter_CSTATE) * HoverControl_P.Constant_Value;
  ...
  HoverControl_B.NProdOut_h = (rtb_Sum2 * HoverControl_U.k_y_pid[2] -
    HoverControl_X.Filter_CSTATE_i) * HoverControl_P.Constant_Value;
  ...
  HoverControl_B.NProdOut_b = (rtb_Sum3 * HoverControl_U.k_z_pid[2] -
    HoverControl_X.Filter_CSTATE_c) * HoverControl_P.Constant_Value;
...
void HoverControlModelClass::initialize()
{
  /* Registration code */
  {
    ...
    rtsiSetContStatesPtr(&(&HoverControl_M)->solverInfo, (real_T **)
                         &(&HoverControl_M)->contStates);
    ...
    rtsiSetErrorStatusPtr(&(&HoverControl_M)->solverInfo, (&rtmGetErrorStatus
      ((&HoverControl_M))));
  ...
  rtsiSetSolverData(&(&HoverControl_M)->solverInfo, static_cast<void *>
                    (&(&HoverControl_M)->intgData));
