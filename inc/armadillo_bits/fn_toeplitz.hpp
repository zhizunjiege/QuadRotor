...
arma_warn_unused inline const Op<T1, op_toeplitz>
...
template <typename T1>
arma_warn_unused inline const Op<T1, op_toeplitz_c>
...
arma_warn_unused inline const Glue<T1, T2, glue_toeplitz>
