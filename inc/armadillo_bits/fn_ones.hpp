...
arma_warn_unused
    arma_inline const Gen<vec, gen_ones>
...
arma_warn_unused
    arma_inline const Gen<obj_type, gen_ones>
...
arma_warn_unused
    arma_inline const Gen<mat, gen_ones>
...
template <typename obj_type>
arma_warn_unused inline const Gen<obj_type, gen_ones>
...
arma_warn_unused
    arma_inline const GenCube<cube::elem_type, gen_ones>
...
arma_warn_unused
    arma_inline const GenCube<typename cube_type::elem_type, gen_ones>
