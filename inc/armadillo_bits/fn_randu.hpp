...
arma_warn_unused inline double
randu()
{
...
arma_warn_unused
    arma_inline const Gen<vec, gen_randu>
...
arma_warn_unused
    arma_inline const Gen<obj_type, gen_randu>
...
arma_warn_unused
    arma_inline const Gen<mat, gen_randu>
    ...
    randu(const uword n_rows, const uword n_cols, const typename arma_Mat_Col_Row_only<obj_type>::result *junk = 0)
{
  ...
  else if (is_Row<obj_type>::value == true)
  {
...
arma_warn_unused
    arma_inline const GenCube<cube::elem_type, gen_randu>
...
arma_warn_unused
    arma_inline const GenCube<typename cube_type::elem_type, gen_randu>
