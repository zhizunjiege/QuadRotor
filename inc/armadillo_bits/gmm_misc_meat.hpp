...
namespace gmm_priv
{
  ...
  inline running_mean_scalar<eT>::running_mean_scalar()
      : counter(uword(0)), r_mean(eT(0))
  {
  ...
  template <typename eT>
  inline const running_mean_scalar<eT> &
  ...
  template <typename eT>
  inline running_mean_vec<eT>::running_mean_vec()
      : last_i(0), counter(0)
  {
    arma_extra_debug_sigprint_this(this);
  }
  ...
  template <typename eT>
  inline running_mean_vec<eT>::running_mean_vec(const running_mean_vec<eT> &in)
      : last_i(in.last_i), counter(in.counter), r_mean(in.r_mean)
  {
    arma_extra_debug_sigprint_this(this);
  }

  template <typename eT>
  inline const running_mean_vec<eT> &
