...
inline const mtGlueCube<uword, T1, T2, glue_rel_lt>
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_gt>
operator>(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T2> &Y)
{
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_lteq>
operator<=(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T2> &Y)
{
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_gteq>
operator>=(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T2> &Y)
{
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_eq>
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_noteq>
operator!=(const BaseCube<typename T1::elem_type, T1> &X, const BaseCube<typename T1::elem_type, T2> &Y)
{
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_and>
operator&&(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T2> &Y)
{
  arma_extra_debug_sigprint();
...
template <typename T1, typename T2>
inline const mtGlueCube<uword, T1, T2, glue_rel_or>
operator||(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T2> &Y)
{
  arma_extra_debug_sigprint();
...
inline const mtOpCube<uword, T1, op_rel_lt_pre>
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_lt_post>
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_gt_pre>
operator>(const typename arma_not_cx<typename T1::elem_type>::result val, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_gt_post>
operator>(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const typename arma_not_cx<typename T1::elem_type>::result val)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_lteq_pre>
operator<=(const typename arma_not_cx<typename T1::elem_type>::result val, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_lteq_post>
operator<=(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const typename arma_not_cx<typename T1::elem_type>::result val)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_gteq_pre>
operator>=(const typename arma_not_cx<typename T1::elem_type>::result val, const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_gteq_post>
operator>=(const BaseCube<typename arma_not_cx<typename T1::elem_type>::result, T1> &X, const typename arma_not_cx<typename T1::elem_type>::result val)
{
  arma_extra_debug_sigprint();
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_eq>
...
template <typename T1>
inline const mtOpCube<uword, T1, op_rel_noteq>
operator!=(const typename T1::elem_type val, const BaseCube<typename T1::elem_type, T1> &X)
{
  arma_extra_debug_sigprint();
