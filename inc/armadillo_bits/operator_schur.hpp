...
inline
    typename enable_if2<
        ...
        const mtGlue<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_schur>>::result
    operator%(
        const T1 &X,
        const T2 &Y)
{
...
inline Mat<typename parent::elem_type>
operator%(
