...
template <typename eT>
inline Col<eT>::Col(const Col<eT> &X)
...
template <typename eT>
inline Col<eT>::Col(const uword in_n_elem)
...
template <typename eT>
inline Col<eT>::Col(const uword in_n_rows, const uword in_n_cols)
...
template <typename eT>
inline Col<eT>::Col(const SizeMat &s)
    : Mat<eT>(arma_vec_indicator(), 0, 0, 1)
{
  arma_extra_debug_sigprint();
...
inline Col<eT>::Col(const uword in_n_elem, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), in_n_elem, 1, 1)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
template <typename fill_type>
inline Col<eT>::Col(const uword in_n_rows, const uword in_n_cols, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), 0, 0, 1)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
template <typename fill_type>
inline Col<eT>::Col(const SizeMat &s, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), 0, 0, 1)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Col<eT>::Col(const char *text)
{
  arma_extra_debug_sigprint();
...
//! construct a column vector from specified text
template <typename eT>
inline Col<eT>::Col(const std::string &text)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Col<eT>::Col(const std::vector<eT> &x)
...
template <typename eT>
inline Col<eT>::Col(const std::initializer_list<eT> &list)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Col<eT>::Col(const SpCol<eT> &X)
    : Mat<eT>(arma_vec_indicator(), X.n_elem, 1, 1)
{
  arma_extra_debug_sigprint_this(this);
...
inline Col<eT>::Col(const Base<eT, T1> &X)
    : Mat<eT>(arma_vec_indicator(), 1)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Col<eT>::Col(eT *aux_mem, const uword aux_length, const bool copy_aux_mem, const bool strict)
...
//! construct a column vector from a given auxiliary array of eTs
template <typename eT>
inline Col<eT>::Col(const eT *aux_mem, const uword aux_length)
...
template <typename eT>
template <typename T1>
inline Col<eT>::Col(const BaseCube<eT, T1> &X)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Col<eT>::Col(const subview_cube<eT> &X)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
arma_inline const Op<Col<eT>, op_htrans>
Col<eT>::t() const
{
...
template <typename eT>
arma_inline const Op<Col<eT>, op_strans>
Col<eT>::st() const
{
...
template <typename eT>
template <uword fixed_n_elem>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const subview_cube<eT> &X)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <uword fixed_n_elem>
template <typename fill_type>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const fill::fill_class<fill_type> &)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <uword fixed_n_elem>
template <typename T1>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const Base<eT, T1> &A)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <uword fixed_n_elem>
template <typename T1, typename T2>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const Base<pod_type, T1> &A, const Base<pod_type, T2> &B)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const eT *aux_mem)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const char *text)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const std::string &text)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Col<eT>::fixed<fixed_n_elem>::fixed(const std::initializer_list<eT> &list)
    : Col<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
arma_inline const Op<typename Col<eT>::template fixed<fixed_n_elem>::Col_fixed_type, op_htrans>
...
template <typename eT>
template <uword fixed_n_elem>
arma_inline const Op<typename Col<eT>::template fixed<fixed_n_elem>::Col_fixed_type, op_strans>
...
template <typename eT>
inline Col<eT>::Col(const arma_fixed_indicator &, const uword in_n_elem, const eT *in_mem)
