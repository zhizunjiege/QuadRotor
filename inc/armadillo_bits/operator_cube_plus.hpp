...
arma_inline const BaseCube<typename T1::elem_type, T1> &
operator+(
...
//! BaseCube + scalar
template <typename T1>
arma_inline const eOpCube<T1, eop_scalar_plus>
operator+(
    const BaseCube<typename T1::elem_type, T1> &X,
...
template <typename T1>
arma_inline const mtOpCube<typename std::complex<typename T1::pod_type>, T1, op_cx_scalar_plus>
operator+(
...
arma_inline const eGlueCube<T1, T2, eglue_plus>
operator+(
    const BaseCube<typename T1::elem_type, T1> &X,
...
template <typename T1, typename T2>
inline const mtGlueCube<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result, T1, T2, glue_mixed_plus>
operator+(
