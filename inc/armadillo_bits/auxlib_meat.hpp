...
auxlib::det_tinymat(const Mat<eT> &X, const uword N)
{
  ...
  case 4:
  {
    ...
    const eT val =
        Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4];
    ...
    const Base<typename T1::pod_type, T1> &expr)
{
...
#if defined(ARMA_USE_LAPACK)
  {
    ...
    {
      vals_mem[i] = std::complex<T>(vals_real[i], vals_imag[i]);
    }
    ...
    const Base<typename T1::pod_type, T2> &B_expr)
{
...
#if defined(ARMA_USE_LAPACK)
  {
    ...
    if (beta_has_zero)
    {
      arma_debug_warn("eig_pair(): given matrices appear ill-conditioned");
    }
...
namespace qz_helper
{
  ...
  select_lhp(const T *x_ptr, const T *y_ptr, const T *z_ptr)
  {
    ...
    {
      return blas_int(0);
    } // consider an infinite eig value not to lie in either lhp or rhp
  ...
  select_iuc(const T *x_ptr, const T *y_ptr, const T *z_ptr)
  {
    ...
    {
      return blas_int(0);
    } // consider an infinite eig value to be outside of the unit circle
