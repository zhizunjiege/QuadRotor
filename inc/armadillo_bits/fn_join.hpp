...
template <typename T1, typename T2>
arma_warn_unused inline const GlueCube<T1, T2, glue_join_slices>
...
template <typename T1, typename T2>
arma_warn_unused inline Cube<typename T1::elem_type>
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_cols>
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_rows>
