...
arma_warn_unused
    arma_inline const Gen<vec, gen_randn>
...
arma_warn_unused
    arma_inline const Gen<obj_type, gen_randn>
...
arma_warn_unused
    arma_inline const Gen<mat, gen_randn>
...
arma_warn_unused
    arma_inline const GenCube<cube::elem_type, gen_randn>
...
arma_warn_unused
    arma_inline const GenCube<typename cube_type::elem_type, gen_randn>
