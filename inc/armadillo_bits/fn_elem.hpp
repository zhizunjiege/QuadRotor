...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_real>
...
template <typename T1>
arma_warn_unused
    arma_inline const mtSpOp<typename T1::pod_type, T1, spop_real>
...
template <typename T1>
arma_warn_unused inline const Gen<Mat<typename T1::pod_type>, gen_zeros>
...
template <typename T1>
arma_warn_unused inline const GenCube<typename T1::pod_type, gen_zeros>
...
template <typename T1>
arma_warn_unused inline SpMat<typename T1::pod_type>
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_imag>
...
template <typename T1>
arma_warn_unused
    arma_inline const mtSpOp<typename T1::pod_type, T1, spop_imag>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_log>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_log2>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_log10>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_exp>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_exp2>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_exp10>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_abs>
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_abs>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_abs>
...
template <typename T1>
arma_warn_unused
    arma_inline const mtSpOp<typename T1::pod_type, T1, spop_cx_abs>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_arg>
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_arg>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_arg>
...
template <typename T1>
arma_warn_unused
    arma_inline const mtSpOp<typename T1::pod_type, T1, spop_cx_arg>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_square>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_square>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_sqrt>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_sqrt>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOp<T1, eop_conj>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_conj>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_conj>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOp<T1, eop_pow>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_pow>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_floor>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_floor>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_ceil>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_ceil>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_round>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_round>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_trunc>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_trunc>
...
template <typename T1>
arma_warn_unused
    arma_inline const eOpCube<T1, eop_sign>
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<T1, spop_sign>
...
template <typename T1>
void exp_approx(const T1 &) { arma_stop_logic_error("unimplemented"); }
template <typename T1>
void log_approx(const T1 &) { arma_stop_logic_error("unimplemented"); }
template <typename T1>
void approx_exp(const T1 &) { arma_stop_logic_error("unimplemented"); }
template <typename T1>
void approx_log(const T1 &) { arma_stop_logic_error("unimplemented"); }
