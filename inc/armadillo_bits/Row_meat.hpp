...
template <typename eT>
inline Row<eT>::Row(const Row<eT> &X)
...
template <typename eT>
inline Row<eT>::Row(const uword in_n_elem)
...
template <typename eT>
inline Row<eT>::Row(const uword in_n_rows, const uword in_n_cols)
    : Mat<eT>(arma_vec_indicator(), 2)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const SizeMat &s)
    : Mat<eT>(arma_vec_indicator(), 2)
{
  arma_extra_debug_sigprint();
...
inline Row<eT>::Row(const uword in_n_elem, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), 1, in_n_elem, 2)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
template <typename fill_type>
inline Row<eT>::Row(const uword in_n_rows, const uword in_n_cols, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), 2)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
template <typename fill_type>
inline Row<eT>::Row(const SizeMat &s, const fill::fill_class<fill_type> &f)
    : Mat<eT>(arma_vec_indicator(), 2)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const char *text)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const std::string &text)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const std::vector<eT> &x)
...
template <typename eT>
inline Row<eT>::Row(const std::initializer_list<eT> &list)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const SpRow<eT> &X)
...
inline Row<eT>::Row(const Base<eT, T1> &X)
    : Mat<eT>(arma_vec_indicator(), 2)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(eT *aux_mem, const uword aux_length, const bool copy_aux_mem, const bool strict)
...
//! construct a row vector from a given auxiliary array
template <typename eT>
inline Row<eT>::Row(const eT *aux_mem, const uword aux_length)
...
template <typename eT>
template <typename T1>
inline Row<eT>::Row(const BaseCube<eT, T1> &X)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
inline Row<eT>::Row(const subview_cube<eT> &X)
{
  arma_extra_debug_sigprint();
...
template <typename eT>
arma_inline const Op<Row<eT>, op_htrans>
Row<eT>::t() const
{
...
template <typename eT>
arma_inline const Op<Row<eT>, op_strans>
Row<eT>::st() const
{
...
inline Row<eT>::fixed<fixed_n_elem>::fixed()
...
template <uword fixed_n_elem>
template <typename fill_type>
inline Row<eT>::fixed<fixed_n_elem>::fixed(const fill::fill_class<fill_type> &)
    : Row<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Row<eT>::fixed<fixed_n_elem>::fixed(const eT *aux_mem)
    : Row<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Row<eT>::fixed<fixed_n_elem>::fixed(const char *text)
    : Row<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Row<eT>::fixed<fixed_n_elem>::fixed(const std::string &text)
    : Row<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
inline Row<eT>::fixed<fixed_n_elem>::fixed(const std::initializer_list<eT> &list)
    : Row<eT>(arma_fixed_indicator(), fixed_n_elem, ((use_extra) ? mem_local_extra : Mat<eT>::mem_local))
{
  arma_extra_debug_sigprint_this(this);
...
template <typename eT>
template <uword fixed_n_elem>
arma_inline const Op<typename Row<eT>::template fixed<fixed_n_elem>::Row_fixed_type, op_htrans>
...
template <typename eT>
template <uword fixed_n_elem>
arma_inline const Op<typename Row<eT>::template fixed<fixed_n_elem>::Row_fixed_type, op_strans>
...
template <typename eT>
inline Row<eT>::Row(const arma_fixed_indicator &, const uword in_n_elem, const eT *in_mem)
