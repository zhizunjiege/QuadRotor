...
arma_inline const Op<derived, op_inv>
...
template <typename derived>
arma_deprecated inline const Op<derived, op_inv>
...
template <typename derived>
arma_inline const Op<derived, op_htrans>
...
template <typename derived>
arma_inline const Op<derived, op_strans>
