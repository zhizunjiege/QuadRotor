...
template <typename oT>
inline field<oT>::field()
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
}
...
template <typename oT>
inline field<oT>::field(const field &x)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
...
template <typename oT>
inline field<oT>::field(const subview_field<oT> &X)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(const uword n_elem_in)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(const uword n_rows_in, const uword n_cols_in)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
//! construct the field with the specified dimensions
template <typename oT>
inline field<oT>::field(const uword n_rows_in, const uword n_cols_in, const uword n_slices_in)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(const SizeMat &s)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(const SizeCube &s)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0), mem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(const std::initializer_list<oT> &list)
    : n_rows(0), n_cols(0), n_slices(0), n_elem(0)
{
  arma_extra_debug_sigprint_this(this);
...
template <typename oT>
inline field<oT>::field(field<oT> &&X)
    : n_rows(X.n_rows), n_cols(X.n_cols), n_slices(X.n_slices), n_elem(X.n_elem)
{
  arma_extra_debug_sigprint(arma_str::format("this = %x   X = %x") % this % &X);
...
template <typename oT>
inline field_injector<field<oT>>
...
template <typename oT>
inline field<oT>::iterator::iterator(field<oT> &in_M, const bool at_end)
    : M(in_M), i((at_end == false) ? 0 : in_M.n_elem)
{
  arma_extra_debug_sigprint();
}
...
template <typename oT>
inline field<oT>::const_iterator::const_iterator(const field<oT> &in_M, const bool at_end)
    : M(in_M), i((at_end == false) ? 0 : in_M.n_elem)
{
  arma_extra_debug_sigprint();
}
...
template <typename oT>
inline field<oT>::const_iterator::const_iterator(const typename field<oT>::iterator &X)
    : M(X.M), i(X.i)
{
  arma_extra_debug_sigprint();
}
