...
public:
  ...
  static const bool is_row =
      (
          ...
          T1::is_row &&
          (is_same_type<op_type, op_sort_default>::yes || is_same_type<op_type, op_shift_default>::yes || is_same_type<op_type, op_shuffle_default>::yes || is_same_type<op_type, op_cumsum_default>::yes || is_same_type<op_type, op_cumprod_default>::yes || is_same_type<op_type, op_flipud>::yes || is_same_type<op_type, op_fliplr>::yes || is_same_type<op_type, op_unique>::yes || is_same_type<op_type, op_diff_default>::yes || is_same_type<op_type, op_normalise_vec>::yes)) ||
      (
          // operations which result in a row vector if the input is a column vector
          T1::is_col &&
          (is_same_type<op_type, op_strans>::yes || is_same_type<op_type, op_htrans>::yes || is_same_type<op_type, op_htrans2>::yes));

  static const bool is_col =
      (
          // operations which always result in a column vector
          is_same_type<op_type, op_diagvec>::yes || is_same_type<op_type, op_vectorise_col>::yes || is_same_type<op_type, op_nonzeros>::yes) ||
      (
