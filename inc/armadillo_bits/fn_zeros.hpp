...
arma_warn_unused
    arma_inline const Gen<vec, gen_zeros>
...
arma_warn_unused
    arma_inline const Gen<obj_type, gen_zeros>
...
arma_warn_unused
    arma_inline const Gen<mat, gen_zeros>
...
arma_warn_unused
    arma_inline const GenCube<cube::elem_type, gen_zeros>
...
arma_warn_unused
    arma_inline const GenCube<typename cube_type::elem_type, gen_zeros>
...
arma_warn_unused inline sp_obj_type
zeros(const uword n_rows, const uword n_cols, const typename arma_SpMat_SpCol_SpRow_only<sp_obj_type>::result *junk = 0)
{
  ...
  else if (is_SpRow<sp_obj_type>::value == true)
  {
    arma_debug_check((n_rows != 1), "zeros(): incompatible size");
  }
