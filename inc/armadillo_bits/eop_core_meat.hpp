  ...
  {                                                                              \
    ...
    {                                                                            \
      ...
      {                                                                          \
        ...
        if (i < n_rows)                                                          \
        {                                                                        \
          *out_mem operatorA eop_core<eop_type>::process(P.at(i, col), k);       \
          out_mem++;                                                             \
        }                                                                        \
      }                                                                          \
    }                                                                            \
  ...
  {                                                                               \
    ...
    {                                                                             \
      ...
      {                                                                           \
        ...
        if (i < n_rows)                                                           \
        {                                                                         \
          *out_mem operatorA eop_core<eop_type>::process(P.at(i, col, slice), k); \
          out_mem++;                                                              \
        }                                                                         \
      }                                                                           \
    }                                                                             \
...
#define arma_applier_1_mp(operatorA)                                                                       \
  {                                                                                                        \
    ...
    _Pragma("omp parallel for schedule(static) num_threads(n_threads)") for (uword i = 0; i < n_elem; ++i) \
    {                                                                                                      \
      out_mem[i] operatorA eop_core<eop_type>::process(P[i], k);                                           \
    }                                                                                                      \
  }
...
#define arma_applier_2_mp(operatorA)                                                                                     \
  {                                                                                                                      \
    ...
    if (n_cols == 1)                                                                                                     \
    {                                                                                                                    \
      _Pragma("omp parallel for schedule(static) num_threads(n_threads)") for (uword count = 0; count < n_rows; ++count) \
      {                                                                                                                  \
    ...
    {                                                                                                                    \
      _Pragma("omp parallel for schedule(static) num_threads(n_threads)") for (uword count = 0; count < n_cols; ++count) \
      {                                                                                                                  \
        out_mem[count] operatorA eop_core<eop_type>::process(P.at(0, count), k);                                         \
      }                                                                                                                  \
    }                                                                                                                    \
