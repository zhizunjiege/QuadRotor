...
arma_warn_unused
    arma_hot inline
    typename enable_if2<(is_arma_sparse_type<T1>::value) && (is_arma_sparse_type<T2>::value) && (is_same_type<typename T1::elem_type, typename T2::elem_type>::value),
                        typename T1::elem_type>::result
    dot(
        const T1 &x,
        const T2 &y)
{
  ...
  if (
      ((SpProxy<T1>::use_iterator == false) && (SpProxy<T2>::use_iterator == false)) && ((is_SpMat<pa_Q_type>::value == true) && (is_SpMat<pb_Q_type>::value == true)))
  {
...
arma_warn_unused
    arma_hot inline
    typename enable_if2<(is_arma_type<T1>::value) && (is_arma_sparse_type<T2>::value) && (is_same_type<typename T1::elem_type, typename T2::elem_type>::value),
                        typename T1::elem_type>::result
    dot(
        const T1 &x,
        const T2 &y)
...
arma_warn_unused
    arma_hot inline
    typename enable_if2<(is_arma_sparse_type<T1>::value) && (is_arma_type<T2>::value) && (is_same_type<typename T1::elem_type, typename T2::elem_type>::value),
                        typename T1::elem_type>::result
    dot(
        const T1 &x,
        const T2 &y)
