...
arma_warn_unused
    arma_inline const Op<T1, op_sum>
    sum(
        const T1 &X,
        const uword dim = 0,
...
template <typename T1>
arma_warn_unused
    arma_inline const Op<Op<T1, op_sum>, op_sum>
...
template <typename T1>
arma_warn_unused
    arma_inline const OpCube<T1, op_sum>
    sum(
...
template <typename T1>
arma_warn_unused
    arma_inline const SpOp<SpOp<T1, spop_sum>, spop_sum>
