...
arma_warn_unused
    arma_inline const Op<T1, op_mean>
    mean(
        const T1 &X,
        const uword dim = 0,
...
template <typename T1>
arma_warn_unused
    arma_inline const Op<Op<T1, op_mean>, op_mean>
...
template <typename T1>
arma_warn_unused
    arma_inline const OpCube<T1, op_mean>
    mean(
...
template <typename T1>
arma_warn_unused inline const SpOp<T1, spop_mean>
mean(
    const T1 &X,
    const uword dim = 0,
