...
arma_warn_unused
    arma_inline const Op<T1, op_min>
    min(
        const T1 &X,
        const uword dim = 0,
...
template <typename T1>
arma_warn_unused
    arma_inline const Op<Op<T1, op_min>, op_min>
...
template <typename T1>
arma_warn_unused
    arma_inline const OpCube<T1, op_min>
    min(
...
template <typename T1, typename T2>
arma_warn_unused
    arma_inline const GlueCube<T1, T2, glue_min>
    min(
        const BaseCube<typename T1::elem_type, T1> &X,
...
template <typename T1>
arma_warn_unused inline const SpOp<SpOp<T1, spop_min>, spop_min>
